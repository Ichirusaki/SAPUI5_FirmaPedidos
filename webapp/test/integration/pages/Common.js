sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("tech/sothis/fcd/FirmarCertificado/app", ".html");
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#FirmaCertificado-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#FirmaCertificado-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("tech.sothis.fcd.FirmarCertificado.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["tech/sothis/fcd/FirmarCertificado/localService/mockserver"], function (mockserver) {
