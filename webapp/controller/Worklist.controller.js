...
sap.ui.define([
	...
	return BaseController.extend("tech.sothis.fcd.FirmarCertificado.controller.Worklist", {
		...
		onFirmarPress: function (oevent) {
			MessageBox.information("Aun no se ha implementado la función para firmar");
		}
